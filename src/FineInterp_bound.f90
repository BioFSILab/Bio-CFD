...
!> This subroutine is only used in one place (at the end of the
!> poissonSolver subroutine). It would probably make sense to just
!> move the loop directly into that subroutine so we can delete this
!> one.
